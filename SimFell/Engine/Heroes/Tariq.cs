...
public class Tariq : Unit
{
    ...
    private void ConfigureTalents()
    {
        ...
        var farBeyondDriven = new Talent(
            ...
            onActivate: unit =>
            {
                _swingTimer.AddModifier(new Modifier(Modifier.StatModType.Flat, -1.5f));
                _heavyStrike.OnCast += (caster, spell, targets) =>
                {
                    ...
                    unit.ApplyBuff(caster, caster, new Aura(
                        ...
                        onApply: (cUnit, tUnit) =>
                        {
                            caster.SpiritStat.AddModifier(spiritMod);
                        },
                        onRemove: (cUnit, cTarget) =>
                        {
                            caster.SpiritStat.RemoveModifier(spiritMod);
                        }
                    ));
                };
            } 
        ...
        var squareHammer = new Talent(
            ...
            onActivate: unit =>
            {
                ...
                _wildSwing.OnCast += (caster, spell, targets) =>
                {
                    ...
                    heavyStrikeBonusDamage = new Modifier(Modifier.StatModType.MultiplicativePercent, currentStacks * damagePerStack);
        ...
        var rideTheLightning = new Talent(
            ...
            onActivate: unit =>
            {
                ...
                _thunderCallAura.OnTick += (caster,target) =>
                {
                    GainFury(0.006);
                };
            } 
        ...
        var schism = new Talent(
            ...
            onActivate: unit =>
            {
                ...
                Modifier damageMod = new Modifier(Modifier.StatModType.Multiplicative, 4.0f);
        ...
        var bloodAndThunder = new Talent(
            ...
            onActivate: unit =>
            {
                _chainLightning.DamageModifiers.AddModifier(new Modifier(Modifier.StatModType.Multiplicative, 1.25f));
                _heavyStrike.OnCast += (caster, spell, targets) =>
                {
